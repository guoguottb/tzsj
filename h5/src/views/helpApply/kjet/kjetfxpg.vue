      ...
      <div id="page1"
        ...
        <div class="A1">
          <van-form @submit="next1">
            ...
            <van-field :name="form.forces[0].title"
            ...
            <van-field :name="form.forces[1].title"
      ...
      <div id="page2"
        ...
        <div>
          <van-form @submit="next2">
            ...
            <van-field :name="form2.forces[0].title"
            ...
            <van-field :name="form2.forces[1].title"
      ...
      <div id="page3"
        ...
        <div>
          <van-form @submit="next3">
            ...
            <van-field :name="form3.forces[0].title"
            ...
            <van-field :name="form3.forces[1].title"
...
import {
  ...
  saveAloneEvaluateOpinionApi, // 直接保存评估意见并生成评估报告
...
export default {
  ...
  methods: {
    ...
    next4 () {
      ...
      if (this.$route.query.childID) {
        saveAloneEvaluateOpinionApi(data).then(res => {
          if (res.status == '+OK') {
            this.$dialog.alert({
              message: '提交成功',
            }).then((res) => {
              console.log("next4", res)
              // this.$router.push('/etpgList')
            })
          } else {
            this.$toast.fail('提交失败')
  ...
  computed: {
    assessScore: {
      get () {
        return this.result[0].score + this.result[1].score + this.result[2].score
      },
      set () { }
    }
  }
