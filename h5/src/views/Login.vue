      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          request({
            ...
            // md5(JSON.parse(JSON.stringify(this.loginForm.password)))
            // JSON.parse(JSON.stringify(this.loginForm.password))
          }).then(res => {
            this.loading = false
            ...
            if (res[0].status == 'ok') {
              ...
              localStorage.setItem('station_handle', res[0].station_handle)
              this.$router.push({
                path: "/Home2"
              })
              /*
