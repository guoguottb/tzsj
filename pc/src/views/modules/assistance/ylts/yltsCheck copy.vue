            ...
            <el-col :span="12">
              <el-form-item label="医疗支出"
                ...
                <el-input v-model="pay.abp_ex4"
                          placeholder="请输入医疗支出"
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex4')"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="教育支出"
                ...
                <el-input v-model="pay.abp_ex5"
                          placeholder="请输入教育支出"
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex5')">
                </el-input>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item label="残疾康复费用支出"
                ...
                <el-input v-model="pay.abp_ex6"
                          ...
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex6')"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="因灾、因意外事故费用支出"
                ...
                <el-input v-model="pay.abp_ex11"
                          ...
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex11')"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="其他支出"
                ...
                <el-input v-model="pay.abp_ex7"
                          placeholder="请输入其他支出"
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex7')"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="家庭总支出"
                ...
                <el-input v-model="pay.abp_ex8"
                          ...
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex8')"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="扣减刚性支出后家庭年收入"
                ...
                <el-input v-model="pay.abp_ex9"
                          ...
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex9')">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="扣减刚性支出后人均年收入"
                ...
                <el-input v-model="pay.abp_ex10"
                          ...
                          @change="changeAmt(scope.$index,scope.row,'pay.abp_ex10')"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="24">
              <el-table :data="estate2"
                ...
                <el-table-column prop="abe_ex2"
                                 ...
                                 min-width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.abe_ex2"
                              @change="keyVerification2(scope.$index,scope.row,'e2.abe_ex2')"></el-input>
                  </template>
                </el-table-column>
            ...
            <el-form :label-position="labelPosition"
              ...
              <el-form-item label="家庭人员总数"
                ...
                <el-input v-model="jisuan.familyNum"
                          placeholder="请输入家庭人员总数"></el-input>
              </el-form-item>
              ...
              <el-form-item label="家庭中法定赡抚养人人数"
                            label-width="200px">
                <el-input style="display:inline-block;"
                          v-model="jisuan.familyFD"
                          placeholder="请输入家庭中法定赡抚养人的人数"></el-input>
              </el-form-item>
              <el-form-item label="家庭成员中未成年人数"
                            label-width="200px">
                <el-select v-model="jisuan.familyChildrens">
                  ...
                  <el-option label="4"
                             value="4"></el-option>
                  <el-option label="5人及以上"
                             value="5人及以上"></el-option>
