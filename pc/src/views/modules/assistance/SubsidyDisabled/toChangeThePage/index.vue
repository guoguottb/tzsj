              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label="行政区域"
                    ...
                    <div class="block"
                         style="width:100%!important">
                      <el-cascader :props="thisprops"
                                   v-model="area"></el-cascader>
                    </div>
                  </el-form-item>
                </el-col>
              </el-row>
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex37')">
                        删除</el-button>
                      <span style="text-align:center">身份证拍照(正反面)(<span style='color:red'>{{imgNum.abd_ex37_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex37', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex37_img"
                                 id="abd_ex37"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                </el-col>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex92')">
                        删除</el-button>
                      <span style="text-align:center">纸质授权书(<span style='color:red'>{{imgNum.abd_ex92_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex92', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex92_img"
                                 id="abd_ex92"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex93')">
                        删除</el-button>
                      <span style="text-align:center">公示图片(<span style='color:red'>{{imgNum.abd_ex93_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex93', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex93_img"
                                 id="abd_ex93"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex94')">
                        删除</el-button>
                      <span style="text-align:center">审核审批表(<span style='color:red'>{{imgNum.abd_ex94_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex94', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex94_img"
                                 id="abd_ex94"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex38')">
                        删除</el-button>
                      <span style="text-align:center">其他证明材料(<span style='color:red'>{{imgNum.abd_ex38_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex38', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex38_img"
                                 id="abd_ex38"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex95')">
                        删除</el-button>
                      <span style="text-align:center">近亲属备案表(<span style='color:red'>{{imgNum.abd_ex95_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex95', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex95_img"
                                 id="abd_ex95"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
                ...
                <el-col :span="12"
                  ...
                  <el-card class="box-card">
                    <div slot="header"
                      ...
                      <el-button style="float: left; padding: 3px 0"
                                 type="text"
                                 @click="handleRemove(uploadImg,'abd_ex96')">
                        删除</el-button>
                      <span style="text-align:center"> 民主评议(<span style='color:red'>{{imgNum.abd_ex96_img}}</span>)</span>
                      <el-button style="float: right; padding: 3px 0"
                                 type="text"
                                 @click="uploads('abd_ex96', 'ruleForm')">上传</el-button>
                    </div>
                    <div class="block">
                      <imageView :imgList="uploadImg.abd_ex96_img"
                                 id="abd_ex96"
                                 @Imgindex='getImgIndex'></imageView>
                    </div>
                  </el-card>
...
<script>
import imageView from '../../imageView'    //图片回显
  ...
  data () {
    return {
      ...
      rules: {
        ...
        abd_ex19: [{ required: true, trigger: 'blur', message: "户籍住址不能为空" }],
  ...
  methods: {
    ...
    handleRemove (file, str) {
      ...
      this.$confirm('是否删除该图片？', "提示", {
        ...
        this.ruleForm[str] = this.uploadImg[str + "_img"].join(",");
    ...
    // 上传图片
    uploads (id, dataName) {
      return console.log(id, dataName)
    ...
    async getDisabilityAllowance (data) {
      console.log(this.$route.query.btnType, '11111');
      ...
      try {
        ...
        if (this.$route.query.eventType == 'addNewData') {

        } else {
          this.ruleForm = error.response.data.data.data
          this.area = this.ruleForm.abd_ex28.split(",")

          // 11.25------------------------------------------------------
          this.uploadImg.abd_ex37_img = this.ruleForm.abd_ex37.split(",");
          this.uploadImg.abd_ex92_img = this.ruleForm.abd_ex92.split(",");
          // this.uploadImg.abd_ex37_img = this.ruleForm.abd_ex37.split(",");
          this.uploadImg.abd_ex93_img = this.ruleForm.abd_ex93.split(",");
          this.uploadImg.abd_ex94_img = this.ruleForm.abd_ex94.split(",");
          this.uploadImg.abd_ex38_img = this.ruleForm.abd_ex38.split(",");
          this.uploadImg.abd_ex95_img = this.ruleForm.abd_ex95.split(",");
          this.uploadImg.abd_ex96_img = this.ruleForm.abd_ex96.split(",");

          console.log(this.uploadImg.abd_ex37_img, '申份证');

          console.log(this.ruleForm.abd_ex37, '身份证');
          ...
          for (let i in this.uploadImg) {
            ...
            // console.log(r,"过滤数组");
            if (i == 'abd_ex37_img') {
              this.ruleForm.abd_ex37 = r.join(",")
              this.uploadImg.abd_ex37_img = r;
            } else if (i == 'abd_ex92_img') {
              this.ruleForm.abd_ex92 = r.join(",")
              this.uploadImg.abd_ex92_img = r;
            } else if (i == 'abd_ex93_img') {
              this.ruleForm.abd_ex93 = r.join(",")
              this.uploadImg.abd_ex93_img = r;
            } else if (i == 'abd_ex94_img') {
              this.ruleForm.abd_ex94 = r.join(",")
              this.uploadImg.abd_ex94_img = r;
            } else if (i == 'abd_ex38_img') {
              this.ruleForm.abd_ex38 = r.join(",")
              this.uploadImg.abd_ex38_img = r;
            } else if (i == 'abd_ex95_img') {
              this.ruleForm.abd_ex95 = r.join(",")
              this.uploadImg.abd_ex95_img = r;
            } else if (i == 'abd_ex96_img') {
              this.ruleForm.abd_ex96 = r.join(",")
              this.uploadImg.abd_ex96_img = r;
            }
          }
          ...
          // }
          if (this.$route.query.btnType == "smhc") {
            this.ruleForm.abd_ex99 = "是"
          }
          this.$forceUpdate();
    ...
    async onsave () {
      try {
        ...
        this.ruleForm.abd_ex28 = this.area.join()
        ...
        this.$message.error("数据修改失败，请完善信息")
