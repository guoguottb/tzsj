        ...
        <el-form v-if="isOk"
          ...
          <el-table :data="dibaoForm.familyInfo.guardians"
            ...
            <el-table-column label="身体状况"
              ...
              <template slot-scope="scope">
                <el-select v-model="dibaoForm.familyInfo.guardians[scope.row.xh-1].actualGuardianHealthStatus">
                  <el-option label="健康"
                             value="健康"></el-option>
                  <el-option label="重病"
                             value="重病"></el-option>
            ...
            <el-table-column label="教育程度"
              ...
              <template slot-scope="scope">
                <el-select v-model="dibaoForm.familyInfo.guardians[scope.row.xh-1].actualGuardianEducationalLevel">
      ...
      <div class="ainfo2">
        <div style="margin-left:20px;text-align:center;border-bottom:1px solid #ddd;padding-bottom:10px;">
          <el-button size="small"
                     type="primary"
                     @click="save('dibaoForm')">保存</el-button>
          <el-button size="small"
    ...
    return {
      ...
      rulesForm: {
        'familyInfo.whetherNoParentInfo': [
          { required: true, message: '请选择是否无父母信息', trigger: 'change', type: 'blur' }
        ],
        'basicInfo.name': [
          ...
          "materials": [
            {
              "name": "困境儿童身份证明材料",
              "type": 0,
              "value": this.materials.childValue
            },
            {
              "name": "困境儿童父母身份证明材料",
              "type": 1,
              "value": this.materials.parentValue
            },
            {
              "name": "困境儿童其他证明材料",
              "type": 2,
              "value": this.materials.otherValue
            }
          ]
        }).then((res) => {
