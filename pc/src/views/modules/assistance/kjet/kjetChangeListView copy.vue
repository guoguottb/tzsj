          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="发放方式"
                            prop="assureInfo.distributionMethod">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="教育资助(元/年)"
                            prop="assureInfo.educationSubsidyOfMoneyy">
                <el-input v-model="dibaoForm.assureInfo.educationSubsidyOfMoneyy"
                          placeholder="请填写教育资助"
                          type="number"></el-input>
              </el-form-item>
            </el-col>
        ...
        <div style="margin-left:20px;margin-top:20px;">
          <ul>
            ...
            <li :class="{listStyle:isShow24}"
                @click="isShow(24)">
              <a :class="{listStyleA:!isShow24}"
                 class="ainfoFont"
                 @click="counter('#page24')">变更记录</a><br>
            </li>
            <li v-if="isReturn"
