  ...
  <div class="g-box">
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column label="性别">
        <template slot-scope="{row}">
          <span :title="row.gender"
                class="ellipsis">{{ row.gender }}</span>
        </template>
      </el-table-column>
      <el-table-column label="年龄">
        <template slot-scope="{row}">
          <span :title="row.age"
                class="ellipsis">{{ row.age }}</span>
        </template>
      </el-table-column>
      <el-table-column label="健康状态">
        <template slot-scope="{row}">
          <span :title="row.healthStatus"
                class="ellipsis">{{ row.healthStatus }}</span>
        </template>
      </el-table-column>
      <el-table-column label="儿童类型">
        <template slot-scope="{row}">
          <span :title="row.typeName"
                class="ellipsis">{{ row.typeName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="儿童补助政策公式"
                       width="160px">
        <template slot-scope="{row}">
          <span :title="row.expression"
                class="ellipsis">{{ row.expression }}</span>
        </template>
      </el-table-column>
      <el-table-column label="儿童生活补贴费"
                       width="140px">
        <template slot-scope="{row}">
          <span :title="row.livingAllowance"
                class="ellipsis">{{ row.livingAllowance }}</span>
        </template>
      </el-table-column>
      <el-table-column label="低保金">
        <template slot-scope="{row}">
          <span :title="row.basicLivingMoney"
                class="ellipsis">{{ row.basicLivingMoney }}</span>
        </template>
      </el-table-column>
      <el-table-column label="残疾人生活补贴费"
                       width="160px">
        <template slot-scope="{row}">
          <span :title="row.disabledSubsidyMoney"
                class="ellipsis">{{ row.disabledSubsidyMoney }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="申请时间"
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.applyTime"
                class="ellipsis">{{ row.applyTime }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="isExamine"
                       ...
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.auditTime"
                class="ellipsis">{{ row.auditTime }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="isApproval"
                       ...
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.approvalTime"
                class="ellipsis">{{ row.approvalTime }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="isFinish"
                       ...
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.completionTime"
                class="ellipsis">{{ row.completionTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="申请人"
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.applyName"
                class="ellipsis">{{ row.applyName }}</span>
        </template>
      </el-table-column>
