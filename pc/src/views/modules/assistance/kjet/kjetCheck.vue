<template>
    ...
    <div class="g-box2">
      <div class="info2">
        <el-form v-if="isOk"
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="收养状态"
                            :prop="isAddChildInfo ? '' : 'basicInfo.adoptedType'">
            ...
            <el-col :span="12">
              <el-form-item label="是否患有艾滋病"
                            :prop="isAddChildInfo ? '' : 'basicInfo.sufferingFromAids'">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="联系电话"
                            :prop="isAddChildInfo ? '' : 'basicInfo.phone'">
                <el-input v-model="dibaoForm.basicInfo.phone"
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="性别"
                            :prop="isAddChildInfo ? '' : 'basicInfo.gender'">
            ...
            <el-col :span="12">
              <el-form-item label="出生日期"
                            :prop="isAddChildInfo ? '' : 'basicInfo.birth'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="民族"
                            :prop="isAddChildInfo ? '' : 'basicInfo.nation'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="户籍类型"
                            :prop="isAddChildInfo ? '' : 'basicInfo.censusRegisterType'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="行为能力"
                            :prop="isAddChildInfo ? '' : 'basicInfo.haveFullCapacity'">
            ...
            <el-col :span="12">
              <el-form-item label="是否在校"
                            :prop="isAddChildInfo ? '' : 'basicInfo.whetherInSchool'">
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="生活状况简述"
                            :prop="isAddChildInfo ? '' : 'basicInfo.livingDesc'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="是否重病"
                            :prop="isAddChildInfo ? '' : 'basicInfo.whetherSeriousIllness'">
            ...
            <el-col :span="12">
              <el-form-item label="重病类型"
                            v-if="dibaoForm.basicInfo.whetherSeriousIllness"
                            :prop="isAddChildInfo ? '' : 'basicInfo.seriousIllnessType'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="是否残疾"
                            :prop="isAddChildInfo ? '' : 'basicInfo.whetherDisability'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item v-if="dibaoForm.basicInfo.whetherDisability"
                            label="残疾类型"
                            :prop="isAddChildInfo ? '' : 'basicInfo.disabilityType'">
            ...
            <el-col :span="12">
              <el-form-item v-if="dibaoForm.basicInfo.whetherDisability"
                            label="残疾等级"
                            :prop="isAddChildInfo ? '' : 'basicInfo.disabilityLevel'">
          ...
          <el-row :gutter="20"
                  v-if="dibaoForm.basicInfo.whetherDisability">
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="入学时间"
                ...
                <!-- <el-cascader v-model="education"
                             :options="options"
                             style="width: 100%"></el-cascader> -->
                <!-- <el-input v-model="dibaoForm.basicInfo.xuezhi"
                          type="number"
              ...
              <el-col :span="24">
                <el-form-item label="遭遇困境类型"
                  ...
                  <el-select v-model="typeOfEncounteringEmergencies"
                      ...
                      changeExperience(
                        $event,
                        'whetherEncounteringEmergencies',
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="是否无父亲信息"
                            :prop="
                  isAddChildInfo ? '' : 'familyInfo.father.whetherNoParentInfo'
                ">
          ...
          <template v-if="!dibaoForm.familyInfo.father.whetherNoParentInfo">
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="父亲姓名"
                              :prop="isAddChildInfo ? '' : 'familyInfo.father.name'">
              ...
              <el-col :span="12">
                <el-form-item label="父亲当前状况"
                              :prop="isAddChildInfo ? '' : 'familyInfo.father.type'">
            ...
            <el-row :gutter="20">
              <el-col :span="12"
                      v-if="
                  dibaoForm.familyInfo.father.type === '重病' ||
                  dibaoForm.familyInfo.father.type === '重病和残疾'
                ">
              ...
              <el-col :span="12"
                      v-if="
                  dibaoForm.familyInfo.father.type === '残疾' ||
                  dibaoForm.familyInfo.father.type === '重病和残疾'
                ">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="是否履行监护责任"
                  ...
                  <el-select v-model="
                      dibaoForm.familyInfo.father.whetherPerformObligations
                    "
                             clearable
                             style="width: 100%">
                    <el-option :value="true"
              ...
              <el-col :span="12"
                      v-if="!dibaoForm.familyInfo.father.whetherPerformObligations">
            ...
            <el-row :gutter="20"
                    v-if="dibaoForm.familyInfo.father.type === '服刑在押'">
              <el-col :span="12">
            ...
            <el-row :gutter="20"
                    v-if="dibaoForm.familyInfo.father.type === '强制戒毒'">
              <el-col :span="12">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="是否有其他限制人身自由措施"
                  ...
                  <el-select v-model="
                      dibaoForm.familyInfo.father.restrictionOfPersonalFreedom
                    "
                             clearable
                             style="width: 100%">
                    <el-option :value="true"
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="是否无母亲信息"
                            :prop="
                  isAddChildInfo ? '' : 'familyInfo.mother.whetherNoParentInfo'
                ">
          ...
          <template v-if="!dibaoForm.familyInfo.mother.whetherNoParentInfo">
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="母亲姓名"
                              :prop="isAddChildInfo ? '' : 'familyInfo.mother.name'">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="母亲当前状况"
                              :prop="isAddChildInfo ? '' : 'familyInfo.mother.type'">
            ...
            <el-row :gutter="20">
              <el-col :span="12"
                      v-if="
                  dibaoForm.familyInfo.mother.type === '重病' ||
                  dibaoForm.familyInfo.mother.type === '重病和残疾'
                ">
              ...
              <el-col :span="12"
                      v-if="
                  dibaoForm.familyInfo.mother.type === '残疾' ||
                  dibaoForm.familyInfo.mother.type === '重病和残疾'
                ">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="是否履行监护责任"
                  ...
                  <el-select v-model="
                      dibaoForm.familyInfo.mother.whetherPerformObligations
                    "
                             clearable
                             style="width: 100%">
                    <el-option :value="true"
              ...
              <el-col :span="12"
                      v-if="!dibaoForm.familyInfo.mother.whetherPerformObligations">
            ...
            <el-row :gutter="20"
                    v-if="dibaoForm.familyInfo.mother.type === '服刑在押'">
              <el-col :span="12">
            ...
            <el-row :gutter="20"
                    v-if="dibaoForm.familyInfo.mother.type === '强制戒毒'">
              <el-col :span="12">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="是否有其他限制人身自由措施"
                  ...
                  <el-select v-model="
                      dibaoForm.familyInfo.mother.restrictionOfPersonalFreedom
                    "
                             clearable
                             style="width: 100%">
                    <el-option :value="true"
          ...
          <el-table :data="dibaoForm.familyInfo.guardians"
            ...
            <el-table-column label="姓名"
              ...
              <template slot-scope="scope">
                <el-input v-model="
                    dibaoForm.familyInfo.guardians[scope.row.xh - 1]
                      .actualGuardianName
                  "></el-input>
              </template>
            </el-table-column>
            <el-table-column label="与儿童关系"
              ...
              <template slot-scope="scope">
                <el-select v-model="
                  ...
                  <el-option label="奶奶"
                             value="奶奶"></el-option>
                  <el-option label="伯伯/叔叔"
                             value="伯伯/叔叔"></el-option>
                  <el-option label="伯母/婶婶"
                             value="伯母/婶婶"></el-option>
                  <el-option label="其他"
                             value="其他"></el-option>
                </el-select>
            ...
            <el-table-column label="教育程度"
              ...
              <template slot-scope="scope">
                <el-select v-model="
                  ...
                  "
                           placeholder="教育程度">
                  <el-option label="文盲/半文盲"
                             value="文盲/半文盲"></el-option>
                  <el-option label="小学"
                             value="小学"></el-option>
                  <el-option label="初中"
                             value="初中"></el-option>
                  <el-option label="高中"
                             value="高中"></el-option>
                  <el-option label="大学及以上学历"
                             value="大学及以上学历"></el-option>
                </el-select>
            ...
            <el-table-column label="亲密程度"
              ...
              <template slot-scope="scope">
                <el-select v-model="
                    dibaoForm.familyInfo.guardians[scope.row.xh - 1].intimacy
                  "
                           style="width: 100%">
                  <el-option label="好"
                             value="好"></el-option>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="是否贫困家庭"
                            :prop="isAddChildInfo ? '' : 'familyInfo.whetherPoorFamilies'">
            ...
            <el-col :span="12">
              <el-form-item v-if="dibaoForm.familyInfo.whetherPoorFamilies"
                            label="贫困类型"
                            :prop="isAddChildInfo ? '' : 'familyInfo.typesOfPoverty'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="收领人与儿童关系"
                            :prop="isAddChildInfo ? '' : 'basicInfo.receiverRelation'">
                <!-- <el-input v-model="dibaoForm.basicInfo.receiverRelation" placeholder="请填与写收领人与儿童关系"></el-input> -->
                <el-select v-model="dibaoForm.basicInfo.receiverRelation"
                           style="width: 100%"
                           placeholder="请填写收领人与儿童关系">
                  <el-option label="本人"
                             value="本人"></el-option>
                  <el-option label="父亲"
                             value="父亲"></el-option>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="发放方式"
                            :prop="isAddChildInfo ? '' : 'basicInfo.collectionMethod'">
            ...
            <el-col :span="12"
              ...
              <el-form-item label="收领人"
                            :prop="isAddChildInfo ? '' : 'basicInfo.receiver'">
          ...
          <template v-if="dibaoForm.basicInfo.collectionMethod !== '福利院发放'">
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="开户人姓名"
                              :prop="isAddChildInfo ? '' : 'basicInfo.bankAccountName'">
                  <el-input v-model="dibaoForm.basicInfo.bankAccountName"
              ...
              <el-col :span="12">
                <el-form-item label="开户行名称"
                              :prop="isAddChildInfo ? '' : 'basicInfo.bankName'">
                  <el-input v-model="dibaoForm.basicInfo.bankName"
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="开户卡号"
                              :prop="isAddChildInfo ? '' : 'basicInfo.bankCardId'">
                  <el-input v-model="dibaoForm.basicInfo.bankCardId"
                            placeholder="请输入开户卡号"></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row :gutter="20"
              ...
              <el-col :span="12">
                <el-form-item label="收领人身份证"
                              :prop="isAddChildInfo ? '' : 'basicInfo.receiverIdCard'">
              ...
              <el-col :span="12">
                <el-form-item label="收领人电话"
                              :prop="isAddChildInfo ? '' : 'basicInfo.receiverPhone'">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="教育资助(元/年)"
                            prop="assureInfo.educationSubsidyOfMoney">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="牵手贫困学子项目资助(元/年)"
                ...
                <el-input v-model="
                    dibaoForm.assureInfo.financialAidForPoorStudentsOfMoney
                  "
  ...
  <el-form-item label="门诊费用报支（这个字段少了）" prop="abc_ex115">
    <el-input v-model="dibaoForm.assureInfo.abc_ex115" type="number" placeholder="请填写门诊费用报支"></el-input>
          ...
          <div class="lineSt"></div>
          <template v-if="
              dibaoForm.basicInfo.whetherSeriousIllness === true ||
              dibaoForm.basicInfo.whetherDisability === true
            ">
            <el-row :gutter="20">
              <el-col :span="12">
              ...
              <el-col :span="12"
                ...
                <el-card class="box-card">
                  <div slot="header"
                    ...
                    <span>儿童头像照片<span v-if="!isAddChildInfo"
                            class="photo_num">(必填)</span>(<span class="photo_num">{{
                        uploadImg.childPhoto.length
                      }}</span>)</span>
                    <el-button style="float: right; padding: 3px 0"
                               v-if="!uploadImg.childPhoto.length"
                               type="text"
                ...
                <el-card class="box-card">
                  <div slot="header"
                    ...
                    <el-button style="float: left; padding: 3px 0"
                               type="text"
                               @click="
                        handleRemove(uploadImg, 'childValue_img', imgInfo)
                      ">
                      删除
                    </el-button>
                    <span>儿童身份证
                      (<span class="photo_num">{{
                        uploadImg.childValue_img.length
                      }}</span>)</span>
                    <el-button style="float: right; padding: 3px 0"
                               type="text"
                ...
                <el-card class="box-card">
                  <div slot="header"
                    ...
                    <el-button style="float: left; padding: 3px 0"
                               type="text"
                               @click="
                        handleRemove(uploadImg, 'parentValue_img', imgInfo)
                      ">
                      删除
                    </el-button>
                    <span>儿童户口本证明材料<span v-if="!isAddChildInfo"
                            class="photo_num">(必填)</span>(<span style="color: red">{{
                        uploadImg.parentValue_img.length
                      }}</span>)</span>
                    <el-button style="float: right; padding: 3px 0"
                               type="text"
                ...
                <el-card class="box-card">
                  <div slot="header"
                    ...
                    <el-button style="float: left; padding: 3px 0"
                               type="text"
                               @click="
                        handleRemove(uploadImg, 'otherValue_img', imgInfo)
                      ">
                      删除
                    </el-button>
                    <span>其他材料(<span style="color: red">{{
                        uploadImg.otherValue_img.length
                      }}</span>)</span>
                    <el-button style="float: right; padding: 3px 0"
                               type="text"
                               @click="uploads('otherValue_img', 'materials', '其他')">上传
                    </el-button>
                  </div>
                  <div class="block">
      ...
      <!-- 母亲和父亲身体状况图片合集 -->
      <el-dialog :visible.sync="motherAndFatherImgArrDialogVisible">
        <img width="100%"
             :src="motherAndFatherImgArrDialogImageUrl"
             alt="" />
      </el-dialog>
      <!-- 点击计算后显示当前填报信息符合的类型 -->
      <el-dialog title="符合救助类型展示"
        ...
        <el-table :data="gridData">
          <el-table-column property="typeName"
                           label="类型名称"
                           width="150"></el-table-column>
          <el-table-column property="money"
                           label="应发金额"></el-table-column>
          <el-table-column property="basicLivingMoney"
                           label="低保金"></el-table-column>
          <el-table-column property="disabledSubsidyMoney"
                           label="残疾人补助金"></el-table-column>
          <el-table-column property="exp"
                           label="计算公式"
                           width="150"></el-table-column>
          <el-table-column property="basis"
                           label="计算依据"
                           width="150"></el-table-column>
      ...
      <div class="ainfo2">
        <div style="
          ...
          <el-button size="small"
                     type="primary"
                     @click="save('dibaoForm')">保 存</el-button>
          <el-button @click="calculateRescueType('dibaoForm')"
                     v-if="
              $route.query.type !== 'kjetspbg' && $route.query.node !== 'sh'
            ">计 算</el-button>
          <el-button size="small"
                     @click="closeView">返 回</el-button>
        </div>
        <div style="margin-left: 20px; margin-top: 20px">
          <ul>
            ...
            <li :class="{ listStyle: isShow18 }"
                @click="isShow(18)">
              <a :class="{ listStyleA: !isShow18 }"
                 class="ainfoFont"
                 @click="counter('#page18')">群团组织及社会关爱情况</a><br />
            </li>
...
import { submitCheckInfoApi } from '@/api/lifeRescue/predicamentChild'
import { addChildInfoApi } from '@/api/lifeRescue/predicamentChild'
...
export default {
  ...
  data () {
    return {
      motherAndFatherImgArrDialogVisible: false, // 父亲母亲重病或残疾图片材料查看的dialog
      motherAndFatherImgArrDialogImageUrl: '', // image url
      dialogTableVisible: false, //是否展开计算出的救助类型
      gridData: [], //计算出的救助类型的表格数据
      isNoParent: true, //是否需要填写父母信息
      isSave: true,
      xzqhArray: [],
      test: {
        xzqhArray: [],
      ...
      rulesForm: {
        ...
        'familyInfo.typesOfPoverty"': [
          { required: true, message: '贫困类型不可为空', trigger: 'change' },
          ,
        ],
        ...
        'familyInfo.father.name': [
          { required: true, message: '父亲姓名不可为空', trigger: 'blur' },
        ],
        'familyInfo.father.type': [
          { required: true, message: '父亲当前状况不可为空', trigger: 'change' },
        ],
        'familyInfo.mother.type': [
          { required: true, message: '母亲当前状况不可为空', trigger: 'change' },
        ],
        'familyInfo.mother.name': [
          { required: true, message: '母亲姓名不可为空', trigger: 'blur' },
        ],
        ...
        'basicInfo.seriousIllnessType': [
          { required: true, message: '请选择重病类型', trigger: 'blur' },
        ],
        'basicInfo.disabilityType': [
          { required: true, message: '请选择残疾类型', trigger: 'blur' },
        ],
        'basicInfo.disabilityLevel': [
        ...
        'familyInfo.typesOfPoverty': [
          { required: true, message: '请选择贫困类型', trigger: 'blur' },
        ],
        ...
        'basicInfo.receiverRelation': [
          {
            required: true,
            message: '请输入收领人与儿童的关系',
            trigger: 'change',
          },
        ],
        'familyInfo.father.whetherNoParentInfo': [
          {
            required: true,
            message: '请选择是否无父亲信息',
            trigger: 'change',
        ...
        'familyInfo.mother.whetherNoParentInfo': [
          {
            required: true,
            message: '请选择是否无母亲信息',
            trigger: 'change',
      ...
      updataImgType: '',
      imgInfo: {},
      // 如果是申请节点的修改页面  根据此布尔值  动态切换是否校验
      isAddChildInfo: this.$route.query.node === 'sh' ? true : false,
    }
  },
  watch: {
    xzqhArray (newA, oldA) {
      if (newA[0]) {
        ...
        this.dibaoForm.basicInfo.completeDivisionCode =
  ...
  methods: {
      ...
      this.getBasic({
        ...
        .catch((res) => {
          if (
            ...
            res.response &&
            res.response.data &&
            res.response.data.status === '+OK'
          ) {
            let data = res.response.data.data
            //console.log(JSON.stringify(res.response.data))
            this.dibaoForm = data
            if (!this.dibaoForm.familyInfo.typesOfPoverty)
              this.dibaoForm.familyInfo.typesOfPoverty = []
            //是否患有重病
            // if (this.dibaoForm.basicInfo.whetherHealth) {
            //   this.dibaoForm.basicInfo.whetherSeriousIllness = false;
            // }
            //赋值给性别和出生日期
            this.dibaoForm.basicInfo.gender = this.getSex(
              this.dibaoForm.basicInfo.idCard
            )
            this.dibaoForm.basicInfo.birth = this.getBirthday(
              this.dibaoForm.basicInfo.idCard
            )
            if (this.dibaoForm.basicInfo.headImage)
              this.uploadImg.childPhoto.push(this.dibaoForm.basicInfo.headImage)
            if (
              this.dibaoForm.materials.length &&
              this.dibaoForm.materials[1].value
            )
              this.materials.parentValue = this.uploadImg.parentValue_img =
                this.dibaoForm.materials[1].value.split(',')
            if (
              this.dibaoForm.materials.length &&
              this.dibaoForm.materials[2].value
            )
              this.materials.otherValue = this.uploadImg.otherValue_img =
                this.dibaoForm.materials[2].value.split(',')
            if (
              this.dibaoForm.materials.length &&
              this.dibaoForm.materials[0].value
            )
              this.materials.childValue = this.uploadImg.childValue_img =
                this.dibaoForm.materials[0].value.split(',')
            // 获取图片数量
            this.getImgNum()
            this.isOk = true
            let xzqhArray = this.dibaoForm.basicInfo.completeDivisionCode
              ? this.dibaoForm.basicInfo.completeDivisionCode.split(',')
              : []
            ...
            // 相关经历
            this.typeOfJuvenileDelinquent = this.dibaoForm.basicInfo
              .typeOfJuvenileDelinquent
              ? this.dibaoForm.basicInfo.typeOfJuvenileDelinquent.split(',')
              : []
            this.typeOfEncounteringEmergencies = this.dibaoForm.basicInfo
              .typeOfEncounteringEmergencies
              ? this.dibaoForm.basicInfo.typeOfEncounteringEmergencies.split(
                ','
              )
              : []
            if (
              this.dibaoForm.basicInfo.educationStage &&
              this.dibaoForm.basicInfo.educationType
            ) {
              this.education = [
                this.dibaoForm.basicInfo.educationStage,
                this.dibaoForm.basicInfo.educationType,
            ...
            // return console.log(this.dibaoForm.basicInfo.tutorialClass,this.dibaoForm.basicInfo.typeOfTutorialClass)
            if (this.dibaoForm.basicInfo.tutorialClass) {
              this.tutorialClass = [
                this.dibaoForm.basicInfo.tutorialClass,
                this.dibaoForm.basicInfo.typeOfTutorialClass,
              ]
            } else {
              this.tutorialClass = [this.dibaoForm.basicInfo.tutorialClass]
            }
            this.typeOfInfringed = this.dibaoForm.basicInfo.typeOfInfringed
              ? this.dibaoForm.basicInfo.typeOfInfringed.split(',')
              : []
            this.isFinish = true
          } else {
    ...
    changeTime2 (val1, val2, val3, val4) {
      if (
        this.dibaoForm.familyInfo[val1][val2] &&
        this.dibaoForm.familyInfo[val1][val3]
      ) {
        let year = new Date(this.dibaoForm.familyInfo[val1][val2]).getFullYear()
        let month =
          new Date(this.dibaoForm.familyInfo[val1][val2]).getMonth() + 1
    ...
    changeXzqhArray (val) {
      ...
      let str =
        ...
        val[1].replace(reg, '') +
        val[2].replace(reg, '')
      // 如果居住地址和户籍地址 没有填写 则给其赋值    else 什么也不做
      if (!this.dibaoForm.basicInfo.residentialAddress)
        this.dibaoForm.basicInfo.residentialAddress = str
      if (!this.dibaoForm.basicInfo.censusRegisterAddress)
        this.dibaoForm.basicInfo.censusRegisterAddress = str
    },
    // 身份证号改变后检查是否符合申请条件
    changeCid (val) {
      ...
      request({
        ...
        .catch((res) => {
          if (
            typeof res.request === 'undefined' ||
            typeof res.response === 'undefined' ||
            res.request.readyState != 4 ||
    ...
    lengthOfSchoolingChange (e) {
      if (e > 10) this.dibaoForm.basicInfo.schoolSystem = 10
      if (e < 0) this.dibaoForm.basicInfo.schoolSystem = 0
      this.dibaoForm.basicInfo.schoolSystem = Math.floor(this.dibaoForm.basicInfo.schoolSystem)
    },
    isShow (n) {
      this.isShow1 = true
      this.isShow2 = true
    ...
    uploads (id, dataName, val) {
      this.updataImgType = val
      if (val === '头像' && this.uploadImg.childPhoto.length)
        return this.$message.warning('儿童头像照片仅限上传一张')
      if (val === '头像') {
        return (this.dialogVisible3 = true)
      }
      return (this.dialogVisible3 = true)
      // return console.log(id, dataName, val, "================");
      // 过滤身份证照片
      //this.dibaoForm.ab_ex10.split(",")--(result)  是有空值的数组

      //r是处理好的数组
      // console.log(this[dataName][id], "this[dataName][id]")
      if (this[dataName][id]) this[dataName][id] = ''
    ...
    uploadEvent (data) {
      ...
      if (this.updataImgType === '儿童') {
        this.uploadImg.childValue_img.push(data)
        // this.materials.childValue.push(data)
      } else if (this.updataImgType === '父母') {
        this.uploadImg.parentValue_img.push(data)
        // this.materials.parentValue.push(data)
      } else if (this.updataImgType === '其他') {
        this.uploadImg.otherValue_img.push(data)
        // this.materials.otherValue.push(data)
      } else if (this.updataImgType === '头像') {
        this.uploadImg.childPhoto.push(data)
        // this.materials.otherValue.push(data)
      }
    ...
    uploadEvent2 () {
      return
      this.uploadImg[this.uploadId + '_img'] =
        this[this.uploadDataName][this.uploadId].split(',')
    ...
    save (formName) {
      // if(this.$route.query.)
      // if (
      //   this.dibaoForm.familyInfo.whetherPoorFamilies &&
      //   !this.dibaoForm.familyInfo.typesOfPoverty.length
      // )
      //   return this.$message.error('家庭经济情况下的贫困类型不可以为空')
      this.isPreservationInformation(formName)
      if (this.isSave) {
        this.dibaoForm.basicInfo.whetherChecked =
          this.$route.query.node === 'sh' ? false : true
        this.dibaoForm.basicInfo.headImage = this.uploadImg.childPhoto.length
          ? this.uploadImg.childPhoto.join()
          : ''
        this.dibaoForm.materials = [
          {
            name: '身份证',
            type: 0,
            value: this.uploadImg.childValue_img.join(),
          },
          {
            name: '户口本',
            type: 1,
            value: this.uploadImg.parentValue_img.join(),
          },
          {
            name: '其他证明',
            type: 2,
            value: this.uploadImg.otherValue_img.join(),
          },
        ]
        // 如果入学时间有值 需要格式化一下
        if (this.dibaoForm.basicInfo.admissionDate) this.dibaoForm.basicInfo.admissionDate = dayjs(this.dibaoForm.basicInfo.admissionDate).format("YYYY-MM-DD")
        // 如果是修改页面会在这里卡断
        if (this.isAddChildInfo) return this.addChildInfo(this.dibaoForm)
        // 如果不是上门核查页面 走不到这里
        this.saveBasic(this.dibaoForm)
          .then((res) => { })
          .catch(async (res) => {
            if (
              res &&
        ...
        alert('必填信息未填写完整,请检查数据是否完整')
      }
    },
    async addChildInfo (data) {
      try {
        await addChildInfoApi(data)
      } catch (error) {
      ...
      if (this.isSave) {
        this.getRescueTransfer({
          ...
          .catch((res) => {
            ...
            if (res.response.data.status == '+OK') {
              this.gridData = res.response.data.data.data
        ...
        alert('请检查参与政策计算的字段是否填写完整')
      }
    },
    //判断需要的信息是否填写完整
    isPreservationInformation (formName) {
      // if (!this.education.length) return this.$message.error("教育情况类型不可为空")
      this.dibaoForm.basicInfo.typeOfJuvenileDelinquent =
        this.typeOfJuvenileDelinquent.join(',')
      this.dibaoForm.basicInfo.typeOfEncounteringEmergencies =
        this.typeOfEncounteringEmergencies.join(',')
    ...
    FMImgArrHandleRemove (file, fileList) {
      console.log(file, fileList)
    },
    FMImgArrHandlePictureCardPreview (file) {
      this.motherAndFatherImgArrDialogImageUrl = file.url
      this.motherAndFatherImgArrDialogVisible = true
    },
  },
}
</script>
