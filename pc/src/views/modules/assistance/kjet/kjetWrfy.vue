  ...
  <div class="g-box">
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column v-if="false"
                       ...
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.childCode"
                class="ellipsis">{{ row.childCode }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="false"
                       label="儿童ID"
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.childId"
                class="ellipsis">{{ row.childId }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="false"
                       label="家庭编号"
                       width="100px">
        <template slot-scope="{row}">
          <span :title="row.familyCode"
                class="ellipsis">{{ row.familyCode }}</span>
        </template>
      </el-table-column>
      <el-table-column label="申请时间"
        ...
        <template slot-scope="{row}">
          <span :title="row.createTime"
                class="ellipsis">{{ row.createTime }}</span>
        </template>
      </el-table-column>
