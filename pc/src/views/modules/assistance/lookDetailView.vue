// 低保查看弹框组件，由于还有很多bug没有处理所以没有使用
<template>
  <div class="g-boxx"
       v-loading="loading">
    <el-dialog title="查看"
               :visible.sync="isShowBox1"
               z-index=1999
               width="80%"
               top="5vh"
               lock-scroll
        ...
        <div class="info2">
          <el-form :inline="true"
            ...
            <div class="top_1"
                    ...
                    <el-card class="box-card">
                      <div slot="header"
                        ...
                        <span><span style="color:red"
                                v-if="auditValue.ab_ex202==''"> * </span>退回材料(<span style='color:red'>{{imgNum.ab_ex175_len}}</span>)</span>
              ...
              <el-row style="margin-top: 10px;"
                ...
                <el-col :span="22">
                  <el-input type="textarea"
                            autosize
                            v-model="auditValue.ab_ex25"></el-input>
                </el-col>
              </el-row>
              <br>
              <el-row style="margin-top: 10px;"
            ...
            <el-dialog title="转办数据完善"
              ...
              <el-row class="button-group">
                <el-button type="primary"
                           icon="el-icon-plus"
                           size="mini"
                           @click="handleAddDetails('familyData')">
                  新增</el-button>
                <el-button type="danger"
                           icon="el-icon-delete"
                           size="mini"
                           @click="handleDelDetails('familyData')">
                  删除</el-button>
              </el-row>
              <el-table :data="familyData"
                        border
                ...
                <el-table-column prop="abm_ex3"
                                 ...
                                 min-width="110">
                  <template slot-scope="scope">
                    <el-input v-model="familyData[scope.row.xh-1].abm_ex3"
                ...
                <el-table-column prop="abm_ex1"
                                 ...
                                 min-width="150">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex1"
                               :disabled="scope.row.abm_ex1=='户主'">
                ...
                <el-table-column prop="abm_ex2"
                                 ...
                                 min-width="190">
                  <template slot-scope="scope">
                    <el-input v-model="familyData[scope.row.xh-1].abm_ex2"
                              :disabled="scope.row.abm_ex1=='户主'"
                ...
                <el-table-column prop="abm_ex5"
                                 ...
                                 min-width="110">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex5"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="男"
                                 value="男"></el-option>
                      <el-option label="女"
                ...
                <el-table-column prop="abm_ex16"
                                 ...
                                 min-width="190">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex16"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="请选择"
                                 value=""></el-option>
                ...
                <el-table-column prop="abm_ex7"
                                 ...
                                 min-width="130">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex7"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="请选择"
                                 value=""></el-option>
                ...
                <el-table-column prop="abm_ex28"
                                 ...
                                 min-width="110">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex28"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="请选择"
                                 value=""></el-option>
                      <el-option label="未婚"
                ...
                <el-table-column prop="abm_ex51"
                                 ...
                                 min-width="200">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex51"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="请选择"
                                 value=""></el-option>
                      <el-option label="老年人"
                ...
                <el-table-column prop=""
                                 ...
                                 min-width="110">
                  <template slot-scope="scope">
                    <el-input v-model="familyData[scope.row.xh-1].age"
                              class="srname"
                ...
                <el-table-column prop=""
                                 ...
                                 min-width="160">
                  <template slot-scope="scope">
                    <el-select v-model="familyData[scope.row.xh-1].work"
                ...
                <el-table-column prop="abm_ex11"
                  ...
                  <template slot-scope="scope">
                    <el-select class="srname"
                               v-model="familyData[scope.row.xh-1].abm_ex11"
                               @change="changeMember(scope.$index)"
                               :disabled="scope.row.abm_ex1=='户主'">
                      <el-option label="请选择"
                                 value=""></el-option>
                ...
                <el-table-column prop="abm_ex52"
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex52"
                ...
                <el-table-column prop="abm_ex39"
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex39"
                ...
                <el-table-column prop="abm_ex40"
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-select v-model="familyData[scope.row.xh-1].abm_ex40"
                               :disabled="scope.row.abm_ex11!='残疾' || scope.row.abm_ex1=='户主' "
                               @change="changeMember(scope.$index)">
                      <el-option label="请选择"
                                 value=""></el-option>
                ...
                <el-table-column prop="abm_ex15"
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-input v-model="familyData[scope.row.xh-1].abm_ex15"
                ...
                <el-table-column prop="abm_ex17"
                                 ...
                                 min-width="100">
                  <template slot-scope="scope">
                    <el-input v-model="familyData[scope.row.xh-1].abm_ex17"
            ...
            <div class="top_1"
              ...
              <el-row style='margin-top:10px'>
                ...
                <el-col :span="14"
                  ...
                  <el-input type="textarea"
                            autosize
                            v-model="publicity.ab_ex35"></el-input>
                </el-col>
                <el-col :span="2"
                        style="line-height: 30px;text-align:center"
            ...
            <template v-if="this.approval.ab_ex13=='特困供养'">
              <h3 class="line_blue"
                  id="page22"
                  v-if="this.type == 'sp'">&emsp;特困信息补充</h3>
              <div class="lineSt"
            ...
            <template v-if="this.basicInf.ab_ex15=='办结' && ['特困供养'].includes(publicity.ab_ex13)">
              <h3 class="line_blue"
                  id="page25"
                  style="margin-top: 20px;">&emsp;特困自理能力评估信息</h3>
              <div class="lineSt"></div>
              <div style="position: relative;">
                <el-table :data="this.familyData"
                          border
                          style="width: 100% ; margin-bottom: 20px;">
                  <el-table-column prop="abm_ex3"
                                   label="被评估人"
            ...
            <template v-if="this.approval.ab_ex13=='特困供养' && this.type != 'sp'">
              <h3 class="line_blue"
                  ...
                  id="page22"
                  v-if="this.approval.ab_ex15=='办结'|| this.approval.ab_ex15=='审批' ">&emsp;特困信息补充</h3>
              <div class="lineSt"
                   v-if="this.approval.ab_ex15=='办结' || this.approval.ab_ex15=='审批'"></div>
              <div class="top_1"
                   v-if="this.approval.ab_ex15=='办结' || this.approval.ab_ex15=='审批'">
                <table class="top_2">
                  <tr style="height:40px;">
          ...
          <div style="margin-left:30px;margin-top:20px;">
            <ul>
              ...
              <li :class="{listStyle:isShow22}"
                  @click="isShow(22)"
                  v-if="(basicInf.ab_ex15=='办结' ||basicInf.ab_ex15=='审批') && basicInf.ab_ex13=='特困供养'"
                  style="height:25px">
                <a class="ainfoFont"
        ...
        <el-dialog title="自理评估结果"
          ...
          <el-table :data="pgjg"
            ...
            <el-table-column property="aer_ex4"
                             label="特困人员"
                             width="100"></el-table-column>
            <el-table-column property="aer_ex9"
                             label="评估得分"
                             width="80"></el-table-column>
            ...
            <el-table-column property="aer_ex13"
                             label="评估人"
                             width="auto"></el-table-column>
            <el-table-column property="aer_ex14"
                             label="评估机构"
                             width="100"></el-table-column>
          </el-table>
        </el-dialog>
