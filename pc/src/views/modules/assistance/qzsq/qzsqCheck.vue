...
<template>
  <div class="g-box">
    <div class="g-box2">
      <div class="info2">
        <el-form :model="dibaoForm"
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="泰州市内/外"
                            style="width:100%">
                <el-radio v-model="dibaoForm.ab_ex240"
                          label="泰州市内">泰州市内</el-radio>
                <el-radio v-model="dibaoForm.ab_ex240"
                          label="泰州市外">泰州市外</el-radio>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
              ...
              <el-table-column prop="abm_ex3"
                ...
                <template slot-scope="scope">
                  <el-input v-model="familyData4[scope.row.xh-1].abm_ex3"
                            @change="keyVerification2(scope.$index,scope.row,'f4.abm_ex3')"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="abm_ex1"
                ...
                <template slot-scope="scope">
                  <el-input v-model="familyData4[scope.row.xh-1].abm_ex1"
                            @change="keyVerification2(scope.$index,scope.row,'f4.abm_ex1')"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="abm_ex15"
                ...
                <template slot-scope="scope">
                  <el-input v-model="familyData4[scope.row.xh-1].abm_ex15"
                            @change="keyVerification2(scope.$index,scope.row,'f4.abm_ex15')"></el-input>
                </template>
              </el-table-column>
            </el-table>
          </div>
          ...
          <h3 class="line_blue"
              id="page3">&emsp;共同生活家庭成员情况 <span style="color:red">*</span></h3>
          <div class="lineSt"></div>
          <el-row class="button-group">
            <el-button type="primary"
                       icon="el-icon-plus"
          ...
          <el-table :data="familyData1"
            ...
            <el-table-column prop="abm_ex15"
                             ...
                             min-width="200">
              <template slot-scope="scope">
                <el-input v-model.trim="familyData1[scope.row.xh-1].abm_ex15"
          ...
          <el-table :data="familyData2"
            ...
            <el-table-column label="赡(扶、抚)养关系"
                             min-width="150">
              <template slot-scope="scope">
            ...
            <el-table-column prop="abm_ex15"
                             ...
                             min-width="200">
              <template slot-scope="scope">
                <el-input v-model.trim="familyData2[scope.row.xh-1].abm_ex15"
          ...
          <h3 class="line_blue"
              id="page8">&emsp;非共同生活赡抚扶养人家庭成员信息</h3>
          <div class="lineSt"></div>
          <el-row class="button-group">
            <el-button type="primary"
                       icon="el-icon-plus"
          ...
          <h3 class="line_blue"
              id="page5">&emsp;家庭前12个月收入情况<span style="color:red">*</span></h3>
          <div class="lineSt"></div>
          <div>
            <el-row class="button-group">
              <el-button type="primary"
            ...
            <el-dialog title="核对类别"
              ...
              <el-form :model="form">
                <el-form-item label="核对类别"
                              ...
                              prop="ab_ex192">
                  <el-select v-model="form.ab_ex192"
                             placeholder="请选核对类别">
                    ...
                    <el-option label="编号己停止使用"
                               value="编号己停止使用"></el-option>
        ...
        <div class="mengBan"
          ...
          <el-card class="box-card calculations">
            <div slot="header"
              ...
              <el-button style="float: right; padding: 3px 0"
                         type="text"
                         @click="closeCalculations">关闭</el-button>
            </div>
            ...
            <el-form :label-position="labelPosition"
              ...
              <el-row :gutter="20">
                <el-col :span="12"
                  ...
                  <el-form-item label="家庭年总刚性支出"
                                label-width="170px">
                    <el-input style="display:inline-block;"
                              v-model="jisuan.familyZzc"
                              @change="changePerson"
                              placeholder="请输入家庭年总刚性支出"></el-input>
                  </el-form-item>
                ...
                <el-col :span="12"
                  ...
                  <el-form-item v-if="jisuan.familyNum=='1' && jisuan.familyFD=='0'"
                                ...
                                label-width="170px">
                    <el-input style="display:inline-block;"
                              v-model="jisuan.lifeCost"
                              placeholder="请输入生活费"></el-input>
                  </el-form-item>
            ...
            <div style="text-align: center; margin:10px auto">
              <el-button type="primary"
                         size="small"
                         @click="getJzData('1')">获取申请数据进行计算</el-button>
              <el-button type="success"
                         size="small"
                         @click="changeJS('2')">使用填报条件进行计算</el-button>
            ...
            <div style="width:99%;margin:10px auto 0px;padding:10px;background-color:#f1f1f1;">
              ...
              <p v-show="jsjgshow1"
                ...
                <el-button type="primary"
                           size="small"
                           v-for="(item,index) in this.jsjg"
                           :key="index"
                           @click="showMoney(item)">{{item}}</el-button>
              </p>
              <!-- <hr> -->
              <el-table :data="moneyData"
                ...
                <el-table-column prop="health"
                                 label="健康状况"
                                 width="150"></el-table-column>
                <el-table-column v-if="this.getHelpType.indexOf('最低生活保障-按户保')!=-1"
                                 prop="addObj"
                                 label="是否为增发对象"
                                 width="150">
                  <template slot-scope="scope">
                    <el-select v-model="scope.row.addObj"
                               @change="add(scope.row.addObj,scope.row)">
                ...
                <el-table-column prop="lifeCost"
                                 v-if="this.getHelpType=='特困人员供养'"
                                 label="生活费"
                                 width="150"></el-table-column>
                <el-table-column prop="careCost"
                                 v-if="this.getHelpType=='特困人员供养'"
                                 label="护理费"
                                 width="150"></el-table-column>
              ...
              <div v-if="showTable && !['低保-重病单列户','低保-重残单列户'].includes(moneyData[0].type)">
                <p v-for="(item,index ) in form3"
                   :key="index"
                   style="text-align: center;margin-top:10px"> <span style="color:green;width:200px;">{{item.name}} </span> 家庭月保障金合计为 {{item.money}} </p>
              </div>
      ...
      <!-- 政策计算 -->
      <!-- 《放弃救助承诺书》 -->
      <el-dialog title="是否自愿放弃救助"
                 :visible.sync="dialogFormVisible2"
                 :before-close="handleClose"
                 z-index=1999>
        <el-form :model="form">
          <span style="color:red">*</span>
          <el-form-item label="是否自愿放弃"
                        class="giveUpTitle2">
          ...
          <div v-show="form2.radio=='自愿放弃'">
            ...
            <div style="display:flex;">
              ...
              <el-form-item label="记录人"
                            prop="ab_ex19"
                            class="giveUpTitle2">
                <el-input v-model="dibaoForm.ab_ex19"
                          placeholder="请输入记录人姓名"
                          style="width:200px"
                          @change="keyVerification(dibaoForm.ab_ex19, 'ab_ex19')"></el-input>
              </el-form-item>
            </div>
          </div>
          ...
          <el-form-item :label-width="formLabelWidth"
            ...
            <el-card class="box-card">
              <div slot="header"
                ...
                <el-button style="float: left; padding: 3px 0"
                           type="text"
                           @click="handleRemove(uploadImg,'ab_ex194')">
                  删除</el-button>
                <span>放弃救助承诺书(<span style='color:red'>{{imgNum.ab_ex194_img}}</span>)</span>
                <el-button style="float: right; padding: 3px 0"
                           type="text"
                           @click="uploads('ab_ex194','dibaoForm')">上传</el-button>
              </div>
              <div class="block">
                <image-view :imgList="uploadImg.ab_ex194_img"
                            id="ab_ex194"
                            @Imgindex='getImgIndex'></image-view>
              </div>
            </el-card>
        ...
        <div slot="footer"
          ...
          <el-button type="primary"
                     @click="giveUpSave">确 定</el-button>
        </div>
      </el-dialog>
      ...
      <div class="ainfo2">
        <div style="margin-left:20px;text-align:center;border-bottom:1px solid #ddd;padding-bottom:10px;">
          <el-button-group>
            ...
            <el-button size="mini"
                       @click="calculations">计算</el-button>
          </el-button-group>
        </div>
...
export default {
  ...
  methods: {
    ...
    // },
    areaChange (val) {
      this.dibaoForm.ab_ex4 ? "" : this.dibaoForm.ab_ex4 = val.join("").replace(/[#0-9]/g, "")
      this.dibaoForm.ab_ex11 ? "" : this.dibaoForm.ab_ex11 = val.join("").replace(/[#0-9]/g, "")
    },
