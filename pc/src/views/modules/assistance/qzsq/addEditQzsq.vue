          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="家庭人口"
                            prop="ab_ex5">
                <el-input v-model.number="dibaoForm.ab_ex5"
                          placeholder="请输入家庭人口"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="联系电话"
                            prop="ab_ex28">
                <el-input v-model.number="dibaoForm.ab_ex28"
                          placeholder="请输入联系电话(手机) "></el-input>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-table-column prop="abm_ex2"
              ...
              <template slot-scope="scope">
                <el-input v-model="familyData1[scope.row.xh-1].abm_ex2"
                          @change="changeCard(scope.$index,scope.row)"></el-input>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="abm_ex52"
              ...
              <template slot-scope="scope">
                ...
                <el-select v-model="familyData1[scope.row.xh-1].abm_ex52"
                  ...
                  <el-option label="请选择"
                             value=""></el-option>
                  <el-option label="急性白血病"
                             value="急性白血病"></el-option>
                  <el-option label="白血病"
                             value="白血病"></el-option>
                  ...
                  <el-option label="血友病"
                             value="血友病"></el-option>
                  <el-option label="血小板减少性紫癜"
                             value="血小板减少性紫癜"></el-option>
                  <el-option label="恶性肿瘤（癌症）"
                             value="恶性肿瘤（癌症）"></el-option>
                  <el-option label="子宫癌"
                             value="子宫癌"></el-option>
                  <el-option label="细胞间质瘤"
                             value="细胞间质瘤"></el-option>
                  <el-option label="心脏病"
                             value="心脏病"></el-option>
                  <el-option label="急性心律衰竭"
                             value="急性心律衰竭"></el-option>
                  <el-option label="心肌梗塞"
                             value="心肌梗塞"></el-option>
                  <el-option label="风湿性心脏病"
                             value="风湿性心脏病"></el-option>
            ...
            <el-col :span="12">
              <el-form-item label="其他金融产品"
                ...
                <el-input v-model="dibaoForm.ab_ex37"
                          placeholder="请输入其他金融产品"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-row :gutter="20"
              ...
              <el-col :span="12"
                ...
                <el-card class="box-card">
                  ...
                  <div class="block">
                    <image-view v-if="uploadImg.ab_ex73_img"
                                :imgList="uploadImg.ab_ex73_img"
                                id="ab_ex73"
                                @Imgindex='getImgIndex'></image-view>
                  </div>
                </el-card>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        { pattern: /^(?:[\u4e00-\u9fa5·]{2,16})$/, message: '姓名格式错误', trigger: 'blur' }],
        ab_ex7: [{
          required: true,
          message: '身份证号不能为空',
          trigger: 'blur'
      ...
      checkedEstate2: [],
      common: [],
      help_reason_list: ['缺乏劳动力', '失业', '疾病', '残疾', '教育', '住房', '受灾', '其他'],
      ab_ex46: [], //求助原因
  ...
  methods: {
    ...
    loadData () {// 进入页面加载数据
      ...
      this.getBasic({
        ...
        // 新增检测
        // if((this.dibaoForm.ab_ex3 == '' || this.dibaoForm.ab_ex162 == '') && this.dibaoForm.ab_id ==''){
        console.log();
    ...
    async save () {
      let reg = /^(?:[\u4e00-\u9fa5]{2,16})$/
      if (!reg.test(this.dibaoForm.ab_ex3)) return this.$message.warning("基本信息下的申请人姓名应为2-16位的汉字")
      this.isSaves = true
      let isSave = true;
      ...
      if (this.isNewData) {
        ...
        if (typeStr[1].indexOf('信息') != -1) {
          typeStr[1] = typeStr[1].split('信息')[0]
        }
        console.log(typeStr[1], 'typeStr[1]---');
        this.dibaoForm.ab_ex13 = typeStr[1];
