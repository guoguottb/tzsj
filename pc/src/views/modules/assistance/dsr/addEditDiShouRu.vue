    ...
    <div class="g-box2">
      <div class="info2">
        <el-form :model="dibaoForm"
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="工资性收入"
                            prop="ab_ex29">
                <el-input v-model="dibaoForm.ab_ex29"
                          placeholder="请输入工资性收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="经营性净收入"
                            prop="ab_ex30">
                <el-input v-model="dibaoForm.ab_ex30"
                          placeholder="请输入经营性净收入"
                          @change="changeAmt">
                </el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="财产性收入"
                            prop="ab_ex31">
                <el-input v-model="dibaoForm.ab_ex31"
                          placeholder="请输入财产性收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="转移性收入"
                            prop="ab_ex32">
                <el-input v-model="dibaoForm.ab_ex32"
                          placeholder="请输入转移性收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="其他收入"
                            prop="ab_ex33">
                <el-input v-model="dibaoForm.ab_ex33"
                          placeholder="请输入其他收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="家庭总收入"
                            prop="ab_ex58">
                <el-input v-model="dibaoForm.ab_ex58"
                          placeholder="请输入家庭总收入"
                          @change="changeAmt">
                </el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="家庭月平均收入"
                            prop="ab_ex94">
                <el-input v-model="dibaoForm.ab_ex94"
                          placeholder="请输入家庭月平均收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="家庭月人均收入"
                            prop="ab_ex94_">
                <el-input v-model="ab_ex94_"
                          placeholder="请输入家庭月人均收入"
                          @change="changeAmt"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
