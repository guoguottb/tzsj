    ...
    <div class='g-box2'>
      <div class="info2">
        <el-form :inline="true"
          ...
          <h3 class="line_blue"
              id="page14">&emsp;非共同生活赡抚扶养人家庭成员信息</h3>
          <div class="lineSt"></div>
          <div class="family">
          ...
          <h3 class="line_blue"
              id="page12"
              style='margin-top:20px'>&emsp;变更报告</h3>
          <div class="lineSt"></div>
          <div class="top_1"
               style='width:95%'>
            <div class='change_item'
                 v-for="(item,index) in changeChild"
                 :key="index">
              <div class='item'
                   v-if="item.acc_ex5_1!='N'">{{item.acc_ex5}}</div>
              ...
              <div v-else>
                <div v-if="item.acc_ex7_1!='N'">
                  <div v-if="item.acc_ex6=='修改'"
                    ...
                    <span class='item_1_1 item_text'>{{item.acc_ex8}}，{{item.acc_ex1}}</span>：从<span style='color:blue'>{{item.acc_ex2=="" ? "空":item.acc_ex2}}</span> 变成 <span style='color:green'>{{item.acc_ex3}}</span>；
                  </div>
                  ...
                  <div v-else-if="item.acc_ex6=='核减'"
                       class='item_1_1'>
                    <div class='item_1'>核减数据：</div><span class='item_1_1 item_text'>{{item.acc_ex1}}</span>：{{item.acc_ex2}} ;
                  </div>
                  <div v-else
                       class='item_1_1'>
                ...
                <div v-else
                  ...
                  <div v-if="item.acc_ex6=='修改'"><span class='item_text'>{{item.acc_ex8}}，{{item.acc_ex1}}</span>：从<span style='color:blue'>{{item.acc_ex2=="" ? "空":item.acc_ex2}}</span> 变成 <span style='color:green'>{{item.acc_ex3}}</span>；
                  </div>
                  <div v-else-if="item.acc_ex6=='删除'">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-card class="box-card">
                  <div slot="header"
                       class="clearfix">
                    <span>身份证（正反面）(<span style='color:red'>{{imgNum.ab_ex10_len}}</span>)</span>
              ...
              <el-col :span="12">
                <el-card class="box-card">
                  <div slot="header"
                       class="clearfix">
                    <span>纸质授权书(<span style='color:red'>{{imgNum.ab_ex177_len}}
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-card class="box-card">
                  <div slot="header"
                       class="clearfix">
                    <span>民主评议(<span style='color:red'>{{imgNum.ab_ex97_len}}
              ...
              <el-col :span="12">
                <el-card class="box-card">
                  ...
                  <image-view :imgList="this.imgArr.ab_ex16_len"
                              height="150px"
                              width="150px"></image-view>
                </el-card>
              </el-col>
          ...
          <!-- 重复预警 -->
          <repeatWarnView id="page20"
                          v-if="',申请,退回,'.indexOf(',' + basicInf.ab_ex15 + ',') == -1"></repeatWarnView>

          <h3 class="line_blue"
              id="page24"
              style='margin-top:15px'>&emsp;汇总表</h3>
          <div class="lineSt"></div>
          ...
          <el-table v-if="this.newData.length>0"
                    :data="newData"
                    border
            ...
            <el-table-column label="变更后汇总表">
              ...
              <el-table-column label="明细"
                ...
                <template slot-scope="scope"
                          v-if="['低保','特困供养',''].includes(publicity.ab_ex13)">
                  <el-button @click="moneyDetail2(scope.row)"
                             type="text"
                             size="small">明细</el-button>
                </template>
              </el-table-column>
          ...
          <div class="top_1"
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-date-picker v-model="auditValue.ac_dat2"
                                type="datetime"
            ...
            <el-row style="margin-top: 10px;">
              ...
              <el-col :span="22">
                <el-input type="textarea"
                          autosize
                          v-model="auditValue.ac_ex5"></el-input>
              </el-col>
            </el-row>
            <el-row style="margin-top: 10px;"
                    type="flex"
          ...
          <div class="top_1"
            ...
            <el-row style="margin-top: 20px;">
              ...
              <el-col :span="6">
                <el-date-picker v-model="approval.ac_dat3"
                                type="datetime"
                                value-format="yyyy-MM-dd HH:mm"
                                placeholder="选择审批时间">
                </el-date-picker>
            ...
            <el-row style="margin-top: 10px;">
              ...
              <el-col :span="22">
                <el-input type="textarea"
                          autosize
                          v-model="approval.ac_ex8"></el-input>
              </el-col>
            </el-row>
            <el-row style="margin-top: 10px;"
                    type="flex"
          ...
          <h3 class="line_blue"
              id="page10"
              v-if="this.type!='zx'">&emsp;审批记录</h3>
          <div class="lineSt"
               v-if="this.type!='zx'"></div>
          <div class="top_1"
               v-if="this.type!='zx'">
            <div class="top_1">
          ...
          <ul>
            ...
            <li :class="{listStyle:isShow13}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page13')">自定义预警信息</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow14}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page14')">非共同生活赡抚扶养人家庭成员信息</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow15}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page15')">家庭前12个月支出情况</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow12}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page12')">变更报告</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow18}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page18')">代理人信息</a><br>
            </li>
            <li :class="{listStyle:isShow20}"
                @click="isShow(20)"
                v-if="',申请,退回,'.indexOf(',' + basicInf.ab_ex15 + ',') == -1"
                style="height:25px">
              <a class="ainfoFont"
                 :class="{listStyleA:!isShow20}"
                 @click="counter('#page20')">重复预警</a>
            </li>
