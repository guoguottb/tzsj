        ...
        <el-form :inline="true"
          ...
          <div class="top_1"
            ...
            <el-row style="margin-top: 10px;"
              ...
              <el-col :span="24"
                      style="text-align: center;"><el-button type="primary"
                           @click="save2(publicity)">保存</el-button></el-col>
            </el-row>
          </div>
          <br>
          ...
          <ul>
            ...
            <li :class="{listStyle:isShow14}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page14')">自定义预警信息</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow15}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page15')">非共同生活赡抚扶养人家庭成员信息</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow16}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page16')">家庭前12个月支出情况</a><br>
            </li>
            ...
            <li :class="{listStyle:isShow17}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page17')">拥有车、船情况</a><br>
            </li>
            <li :class="{listStyle:isShow18}"
                @click="isShow(18)">
              <a class="ainfoFont"
                 :class="{listStyleA:!isShow18}"
                 @click="counter('#page18')">拥有房产情况</a><br>
            </li>
