      ...
      <el-table class="oneTh"
        ...
        <el-table-column label="地区"
          ...
          <template slot-scope="{row}">
            <p :title="row.area"
               class="ellipsis">{{row.area}}</p>
          </template>
        </el-table-column>
        <el-table-column label="临时救助对象"
                         width="80">
          <template slot-scope="{row}">
            <p :title="row.entire"
               class="ellipsis">{{row.entire}}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="ab_ex2"
          ...
          <el-table-column label="本地户籍"
            ...
            <template slot-scope="{row}">
              <p :title="row.within"
                 class="ellipsis">{{row.within}}</p>
            </template>
          </el-table-column>
          <el-table-column label="非本地户籍">
            <template slot-scope="{row}">
              <p :title="row.nonlocal"
                 class="ellipsis">{{row.nonlocal}}</p>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column prop="ab_ex2"
          ...
          <el-table-column label="特困对象"
            ...
            <template slot-scope="{row}">
              <p :title="row.tk"
                 class="ellipsis">{{row.tk}}</p>
            </template>
          </el-table-column>
          <el-table-column label="其他">
            <template slot-scope="{row}">
              <p :title="row.annum"
                 class="ellipsis">{{row.annum}}</p>
            </template>
          </el-table-column>
        </el-table-column>
