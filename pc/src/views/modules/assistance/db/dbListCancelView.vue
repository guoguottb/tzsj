        ...
        <el-form :inline="true"
          ...
          <div class="top_1"
            ...
            <el-row style="margin-top: 10px;">
              ...
              <el-col :span="22"><el-input type="textarea"
                          autosize
                          v-model="auditValue.ac_ex2"></el-input></el-col>
            </el-row>
            <el-row style="margin-top: 10px;"
                    type="flex"
                    justify="center">
          ...
          <div class="top_1"
            ...
            <el-row>
              ...
              <el-col :span="16">
                <el-date-picker v-model="publicity.ac_dat1"
                                type="datetime"
                                value-format="yyyy-MM-dd HH:mm"
                                placeholder="选择注销时间">
                </el-date-picker>
            ...
            <el-row style="margin-top: 10px;">
              ...
              <el-col :span="20"><el-input type="textarea"
                          autosize
                          v-model="publicity.ac_ex8"></el-input></el-col>
            </el-row>
            <el-row style="margin-top: 10px;"
                    type="flex"
                    justify="center">
          ...
          <div class="top_1"
            ...
            <el-row style="margin-top: 10px;">
              ...
              <el-col :span="22"><el-input type="textarea"
                          autosize
                          v-model="approval.ac_ex5"></el-input></el-col>
            </el-row>
            <el-row style="margin-top: 10px;"
                    type="flex"
                    justify="center">
          ...
          <ul>
            ...
            <li :class="{listStyle:isShow12}"
              ...
              <a class="ainfoFont"
                 ...
                 @click="counter('#page12')">注销报告</a><br>
            </li>
