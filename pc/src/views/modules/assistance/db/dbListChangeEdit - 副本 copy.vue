  ...
  <div class="g-box">
    <div class='g-box2'>
      <div class="info2">
        <el-form :model="dibaoForm"
          ...
          <h3 class="line_blue"
              id="page9">&emsp;非共同生活赡抚扶养人家庭成员信息</h3>
          <div class="lineSt"></div>
          <el-row class="button-group">
            <el-button type="primary"
                       icon="el-icon-plus"
          ...
          <h3 class="line_blue"
              id="page13"
              style="margin-top:10px">&emsp;居住状况照片</h3>
          <div class="lineSt"></div>
          <el-row :gutter="20">
            <el-col :span="12"
                    class="my-col">
          ...
          <template v-if="this.dibaoForm.ab_ex13=='特困供养'">
            <h3 class="line_blue"
                id="page22"
                style="margin-top:20px">&emsp;特困信息补充</h3>
            <div class="lineSt"></div>
            <div class="top_1">
              <el-row :gutter="20"
      ...
      <div class="ainfo2">
        <div style="margin-left:20px;text-align:center;border-bottom:1px solid #ddd;padding-bottom:10px;">
          ...
          <el-button size="small"
                     @click="getDatailMoney">明细</el-button>
        </div>
    ...
    <el-dialog title="政策计算器提醒"
      ...
      <div style="font-size:16px;">
        ...
        <select v-if="this.jsjgString=='特困人员供养' && ['低保','特困供养'].includes(this.dibaoForm.ab_ex13)"
                v-model="ab_ex13"
