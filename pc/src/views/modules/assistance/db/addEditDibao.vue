          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="预警内容1"
                            prop="aw_ex1">
                <el-input v-model="warningData[0].aw_ex1"
                          placeholder="请输入预警内容"
            ...
            <el-col :span="12">
              <el-form-item label="预警时间1"
                            prop="aw_ex1"
                            disabledDate>
                <el-date-picker v-model="warningData[0].aw_dat1"
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="预警内容2"
                            prop="aw_ex1">
                <el-input v-model="warningData[1].aw_ex1"
                          placeholder="请输入预警内容"
                          @change="changeAmt2"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="预警内容3"
                            prop="aw_ex1">
                <el-input v-model="warningData[2].aw_ex1"
                          placeholder="请输入预警内容"
                          @change="changeAmt2"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-table-column prop="abm_ex2"
              ...
              <template slot-scope="scope">
                <el-input v-model="familyData3[scope.row.xh-1].abm_ex2"
                          @change="changeCard3(scope.$index,scope.row)"></el-input>
              </template>
            </el-table-column>
          </el-table>
          <h3 class="line_blue"
