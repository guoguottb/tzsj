        ...
        <el-form :inline="true"
            ...
            <el-row style="margin-top: 10px;"
              ...
              <el-col :span="24"
                ...
                <el-button type="primary"
                           @click="save(auditValue)">保存</el-button>
          ...
          <el-dialog title="转办数据完善"
            ...
            <el-row v-if="!arb">
              ...
              <el-col :span="22">
                (<el-radio-group style="margin: 0 5px"
                                :disabled="disabled"
                                v-model="typeData.ab_ex13">
                  <el-radio label="低保"
                            :value="'低保'"
                            v-show="dbShow"
              ...
              <el-table-column prop="abm_ex51"
                ...
                <template slot-scope="scope">
                  <el-select v-model="tableData[scope.row.xh-1].abm_ex51"
                    ...
                    <el-option label="独居"
                               value="独居"></el-option>
                    <el-option label="散居归侨侨属"
                               value="散居归侨侨属"></el-option>
            ...
            <div slot="footer"
              ...
              <el-button type="primary"
                         @click="saveZB(auditValue)">确 定</el-button>
            </div>
          </el-dialog>
          ...
          <div class="top_1"
              ...
              <el-col :span="12">
                <el-card class="box-card">
                  <div slot="header"
                    ...
                    <span><span v-if="publicity.ab_ex34=='有异议退回'"
            ...
            <el-row style="margin-top: 10px;"
              ...
              <el-col :span="24"
                      style="text-align: center;">
                <el-button type="primary"
                           @click="save2(publicity)">保存</el-button>
              </el-col>
            </el-row>
          </div>
          <br>
          ...
          <template v-if="this.approval.ab_ex13=='特困供养'">
            ...
            <div class="top_1"
              ...
              <el-row :gutter="20"
                ...
                <el-col :span="6">
                  <el-input v-model="approval.ab_ex199"
                            placeholder="请输入护理费"
                            @change="keyVerification(approval.ab_ex199,'ab_ex199')"></el-input>
                </el-col>
              ...
              <el-row :gutter="20"
                ...
                <el-col :span="6">
                  <el-input v-model="approval.ab_ex200"
                            placeholder="请输入生活费"
                            @change="keyVerification(approval.ab_ex200,'ab_ex200')"></el-input>
                </el-col>
          ...
          <div class="top_1"
            ...
            <el-row style="margin-top: 10px;"
              ...
              <el-col :span="24"
                      style="text-align: center;">
                <el-button type="primary"
                           @click="checkRepeat()">保存</el-button>
              </el-col>
            </el-row>
          </div>
          <br>
