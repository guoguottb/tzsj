<template>
  <div class="wrapper"
    ...
    <div v-if="show">
      ...
      <!-- 侧边栏组件 -->
      <v-sidebar :items="listitmes"
                 v-if="!headBanner"></v-sidebar>
        ...
        <div class="content-outer">
          ...
          <div class="content"
            ...
            <el-breadcrumb separator="/"
                           v-if="!headBanner">
              <el-breadcrumb-item v-for="item in _route"
  ...
  created () {
    ...
    menuList.push(
          ...
          // },
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: null,
                icon: "el-icon-setting",
                menuId: "96db7e7e42be4a04952854239463174hdbgfhyj",
                menuName: "核对报告复核预警",
                parentMenuId: "b9cedcyyj24196a5427665928605620",
                requestAction: "checkEarlyWarning",
                seq: 500,
              },
            ],
            icon: "el-icon-setting",
        ...
        children: [
          {
            ...
            children: null,
            icon: "el-icon-setting",
            menuId: "96db7e7e42be4a04952854239463174sgzgl",
            menuName: "救助服务站管理",
            parentMenuId: "96db7e7e42be4a04952854239463174SGZ",
            requestAction: "SocialWorkStationManage",
            seq: 500,
          },
          {
            appId: "2002",
            children: [{
              ...
              children: null,
              icon: "el-icon-setting",
              menuId: "96db7e7e42be4a04952854239463174SGZKHLB",
              menuName: "救助服务站考核列表",
              parentMenuId: "96db7e7e42be4a04952854239463174SGZKHGL",
              requestAction: "SocialWorAssess",
              seq: 500,
            },
            {
              appId: "200202",
              children: null,
              icon: "el-icon-setting",
              menuId: "96db7e7e42be4a04952854239463174SGZRYKHLB",
              menuName: "工作人员考核列表",
              parentMenuId: "96db7e7e42be4a04952854239463174SGZKHGL",
              requestAction: "SocialWorStaffAssess",
              seq: 500,
            },],
            icon: "el-icon-setting",
            menuId: "96db7e7e42be4a04952854239463174SGZKHGL",
            menuName: "考核管理",
            parentMenuId: "96db7e7e42be4a04952854239463174SGZ",
            requestAction: "",
            seq: 500,
          },
          {
            ...
            children: null,
            icon: "el-icon-setting",
            menuId: "96db7e7e42be4a04952854239463174SGZPC",
            menuName: "救助服务站批次",
            parentMenuId: "96db7e7e42be4a04952854239463174SGZ",
            requestAction: "socialWorkStationBatch",
            seq: 500,
          },
          {
            appId: "2004",
            children: null,
            icon: "el-icon-setting",
            menuId: "96db7e7e42be4a04952854239463174sgzgdgl",
            menuName: "工单管理",
            parentMenuId: "96db7e7e42be4a04952854239463174SGZ",
            requestAction: "workorderManagement",
            seq: 500,
          },
        ],
        icon: "el-icon-setting",
        menuId: "96db7e7e42be4a04952854239463174SGZ",
        menuName: "救助服务站",
        parentMenuId: "",
        requestAction: "",
        seq: 500,
            ...
            children: [
              {
                ...
                // children: null,
                icon: "el-icon-setting",
                menuId: "b9cedcjr24196a54276659286056508wjbtffxt",
                menuName: "物价补贴发放",
                parentMenuId: "b9cedcjr24196a54276659286056508btffxt",
                requestAction: "SubsidyDisbursementSystem",
                seq: 100,
              }
            ],
            icon: "el-icon-setting",
            menuId: "b9cedcjr24196a54276659286056508btffxt",
            menuName: "物价补贴发放系统",
            parentMenuId: "96db7e7e42be4a04952854239463175ff",
            requestAction: "",
            seq: 100,
          ...
          // },
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: null,
                icon: "el-icon-setting",
                menuId: "96jm7e7e42be4a04952854239463174jjhdxt",
                menuName: "经济核对系统",
                parentMenuId: "96db7e7e42be4a04952854239463174sjjhdxt",
                requestAction: "economicsCheckSystem",
                seq: 500,
              },
            ],
            icon: "el-icon-setting",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                appId: "080403",
                icon: "el-icon-setting",
                menuId: "96db7e7e42be4a04952854239463177exceptionalAssess",
                menuName: "特困自理能力评估",
                parentMenuId: "96db7e7e42be4a04952854239463177exceptionalAssess",
                requestAction: "exceptionalAssess",
                seq: 100,
              },
              {
                appId: "080404",
          ...
          },
          {
            ...
            children: null,
            icon: "el-icon-setting",
            menuId: "b9cedfedx24196a542766592860567dsjzs",
            menuName: "大数据展示",
            parentMenuId: "b9cedfedx24196a542766592860567sjzx",
            requestAction: "Tjfx",
            seq: 100,
      ...
      },
      {
        ...
        children: null,
        icon: "el-icon-setting",
        menuId: "b9cedfedx24196a542766592860567systemVersions",
        menuName: "系统版本",
        parentMenuId: "",
        requestAction: "systemVersions",
        seq: 100
      },
    );
