...
const globalRoutes = [
  ...
  },
  {
    ...
    path: '/Tjfx',
    name: 'Tjfx',
    component: _import('modules/assistance/dsjzs/Tjfx'),
  },
]
// 主入口路由(需嵌套上左右整体布局)
const mainRoutes = {
  ...
  children: [
    ...
    {
      //经济核对系统
      path: '/economicsCheckSystem',
      name: 'economicsCheckSystem',
      component: _import('modules/assistance/tbjm/economicsCheckSystem'),
      meta: {
        title: '经济核对系统',
      },
      children: [],
    ...
    {
      path: '/social/assistance/kjet/kjetCheck',
      component: _import('modules/assistance/kjet/kjetCheck'),
      name: 'assistance/kjet/kjetCheck',
      meta: {
        title: '困境儿童信息更改',
      },
      children: [],
    ...
    {
      path: '/assistance/kjet/kjetCheck',
      name: 'assistance/kjet/kjetCheck',
      component: _import('modules/assistance/kjet/kjetCheck'),
      meta: {
        title: '困境儿童上门核查',
    ...
    {
      path: '/supplementaryMaterials',
      component: _import('modules/assistance/ls/supplementaryMaterials'),
    ...
    {
      path: '/SubsidyDisbursementSystem',
      component: _import(
        'modules/assistance/SubsidyDisbursementSystem/SubsidyDisbursementSystem'
      ),
      name: 'SubsidyDisbursementSystem',
      meta: {
        title: '物价补贴发放系统',
      },
      children: [],
    ...
    {
      path: '/assistance/tjfx/exceptionalAssess',
      component: _import('modules/assistance/tjfx/exceptionalAssess'),
      name: 'exceptionalAssess',
      meta: {
        title: '特困自理能力评估',
      },
      children: [],
    ...
    {
      path: '/jyyj',
      component: _import('modules/assistance/zdjcyjk/jyyj'),
      name: 'jyyj',
      meta: {
        title: '教育预警',
      },
    ...
    {
      path: '/checkEarlyWarning',
      name: 'checkEarlyWarning',
      component: () =>
        import(
          '@/views/modules/assistance/earlyWarningPlatformSystem/checkEarlyWarning'
        ),
      meta: {
        title: '核对报告复核预警',
      },
    ...
    {
      path: '/assistance/kjet/kjetRescueTransfer',
      name: 'assistance/kjet/kjetRescueTransfer',
      component: _import('modules/assistance/kjet/kjetRescueTransfer'),
      meta: {
        title: '救助转移',
      },
      children: [],
    ...
    {
      path: '/SocialWorkStationManage',
      name: 'SocialWorkStationManage',
      component: _import(
        'modules/assistance/SocialWorkStation/SocialWorkStationManage/index'
      ),
      meta: {
        title: '救助服务站管理',
      },
    ...
    {
      path: '/SocialWorkStationManage/staffManagement',
      name: 'staffManagement',
      component: _import(
        'modules/assistance/SocialWorkStation/SocialWorkStationManage/staffManagement'
      ),
      meta: {
        title: '救助服务站 / 人员管理',
      },
    ...
    {
      path: '/SocialWorAssess',
      name: 'SocialWorAssess',
      component: _import(
        'modules/assistance/SocialWorkStation/appraisalManage/SocialWorAssess'
      ),
      meta: {
        title: '救助服务站 / 救助服务站考核列表',
      },
      children: [],
    },
    {
      ...
      name: 'assessDetail',
      component: _import(
        'modules/assistance/SocialWorkStation/appraisalManage/assessDetail'
      ),
      meta: {
        title: '救助服务站 / 救助服务站考核列表 / 查看页面',
      },
      children: [],
    },
    {
      path: '/SocialWorStaffAssess',
      name: 'SocialWorStaffAssess',
      component: _import(
        'modules/assistance/SocialWorkStation/appraisalManage/SocialWorStaffAssess'
      ),
      meta: {
        title: '救助服务站 / 工作人员考核列表',
      },
      children: [],
    },
    {
      path: '/socialWorkStationBatch',
      name: 'socialWorkStationBatch',
      component: _import(
        'modules/assistance/SocialWorkStation/socialWorkStationBatch/index'
      ),
      meta: {
        title: '救助服务站批次',
      },
    ...
    {
      path: '/socialWorkStationBatch/batchInfo',
      name: 'socialWorkStationBatchBatchInfo',
      component: _import(
        'modules/assistance/SocialWorkStation/socialWorkStationBatch/batchInfo'
      ),
      meta: {
        title: '救助服务站批次 / 批次详情',
      },
    ...
    },
    {
      ...
      component: () =>
        import(
          '@/views/modules/assistance/SocialWorkStation/workorderManagement'
        ),
      meta: {
        title: '工单管理',
      },
    ...
    {
      path: '/assistance/jg/pzjl',
      name: 'assistance/jg/pzjl',
      component: _import('modules/assistance/jg/pzjl'),
      meta: {
        title: '批注记录',
      },
      children: [],
    ...
    {
      path: '/systemVersions',
      component: () => import('@/views/modules/assistance/systemVersions'),
      name: 'systemVersions',
      meta: {
        title: '系统版本',
      },
